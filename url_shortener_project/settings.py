...
SECRET_KEY = 'django-insecure-1pq*hd(f(z7udha13bk0(g^l&y9aed!+3**46dtvm5js+))xj2'
...
AUTH_USER_MODEL = 'url_shortener_app.UserModel'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'url_shortener_app/static')
]
